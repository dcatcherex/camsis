...
const hero =
  "This course is suitable for all top decision-makers of school administration such as school owners, executive leaders, and principals interested in professional development in managing a school.";
...
const summary = (`Decision makers and top leadership in school management have tremendous power to impact the educational landscape in the region positively. In this course, participants will be exposed to essential knowledge in administration and leadership to enhance their schools’ quality. 
`)

const summary2 = ("Most importantly, participants will gain insight into the latest educational trends and research, as well as effective strategies for enhancing your school’s visibility which is a part of professional development in leadership and school management. In the process, participants will learn the required skills to foster trust and cultivate a collective sense of efficacy within their team. Lastly, this course also provides opportunities for participants to connect with an international community and its high-quality network, for instance, through sessions from school visits.")

const objective = [
  'Important concepts related to school management and school leadership',
  'Skills to lead their schools effectively in an increasingly complex and interconnected world of education','Exposure to global education trends, including topics such as play pedagogy, how education has become globalised and its influence on today’s educational sector','Essential knowledge for effective school management and students recruitment'
    ...
    <div>
      ...
      <div className="max-w-[1280px] mx-auto grid grid-cols-1 sm:grid-cols-2 gap-4 p-8">
        <div>
          ...
          <h4 className="mt-4">This course aims to provide participants with:</h4>
