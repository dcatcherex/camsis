      ...
      >
        <div className="max-w-[1280px] mx-auto p-8 text-center sm:text-left">
          <div className="lg:max-w-[50%]">
            ...
            <p className="text-white font-semibold text-lg mt-4">Address:</p>
            <ul className="text-white text-left list-none">
              <li>CAMSIS Education Ltd.</li>
              <li>Stirling House</li>
              <li>Cambridge Innovation Park</li>
              <li>Denny End Road</li>
              <li>Cambridge CB25 9PB</li>
            </ul>
          </div>
        </div>
      </div>
